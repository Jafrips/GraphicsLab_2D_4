...
void Sprite_animation(GLuint texture, int n, Hero *obj)
{
    ...
    static float svertix[]= {0,0, 90,0, 90,90, 0,90};
...
//cout << right << "   " << tile_right << "   " << left << "     " << tile_right << endl;
//   cout << right << "     " << tile_left << endl << hero.dx + speed << "   " << hero.x + hero.HERO_WIDTH<< endl;
// if character hits left tile's edge
                    ...
                    // if character hits right tile's edge
